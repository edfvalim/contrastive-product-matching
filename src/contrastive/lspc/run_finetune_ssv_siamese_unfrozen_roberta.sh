...
CUDA_VISIBLE_DEVICES=0 python run_finetune_siamese.py \
	--model_pretrained_checkpoint /home/eduardovalim/Documents/constrastive-product-matching/reports/contrastive/computers-ssv-$SIZE-$PREAUG$BATCH-$LR-$TEMP-roberta-base/pytorch_model.bin \
    --do_train \
	--frozen=False \
    ...
    --output_dir /home/eduardovalim/Documents/constrastive-product-matching/reports/contrastive-ft-siamese/computers-ssv-$SIZE-$AUG$BATCH-$PREAUG$LR-$TEMP-unfrozen-roberta-base/ \
